var items = new Firebase("https://dxddddd.firebaseIO.com/items");
var nowItem = "";
...
function updateItem(title, price, descrip, pic) {
  ...
  items.update({"title":title, "price": parseInt(price), "descrip":descrip, "imgD":pic, "userTime": new Date($.now()).toLocaleString()});
